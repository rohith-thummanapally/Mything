...
export default class Expensescontroller {
    ...
    async addExpense(req, res, next) {
        ...
        try {
            let { name, amount, category, tags, date } = req.body;
    ...
    async getdaywiseExpenses(req, res, next) {
        ...
        console.log(req.body);
        try {
            let { categoires, tags, fromdate, todate } = req.body;
            let userid = req.userid;
    ...
    async gettagwiseExpenses(req, res, next) {
        try {
            ...
            console.log(req);
            let { categories, tags, fromdate, todate } = req.query;
            let userid = req.userid;
            let user = validateuser(userid);
            if (!user) {
                return res.status(500).send({ "success": false, "msg": "User Not Found" });
                ...
                let data = await this.expensesmodel.gettagwiseExpenses(userid, fromdate, todate, categories, tags);
                console.log('after getting data');
                console.log(data);
                return res.status(200).send({ "success": true, "msg": "data found successfully", "data": data });
            }
    ...
    async getcategorywiseExpenses(req, res, next) {
        try {
            ...
            if (!user) {
                ...
                let data = await this.expensesmodel.getcategorywiseExpenses(userid, fromdate, todate, categories, tags);
                console.log('after getting data');
                console.log(data);
                return res.status(200).send({ "success": true, "msg": "data found successfully", "data": data });
            }
    ...
    async getuserExpenses(req, res, next) {
        try {
            ...
            console.log(req.body);
            let { start, limit, categories, tags, fromdate, todate } = req.body;
            let userid = req.userid;
            let user = validateuser(userid);
            if (!user) {
                return res.status(500).send({ "success": false, "msg": "User Not Found" });
                ...
                let data = await this.expensesmodel.getuserExpenses(userid, start, limit, categories, tags, fromdate, todate);
