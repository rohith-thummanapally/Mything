        ...
        <div className="expenses">
            ...
            <div className="pagestyle">
                <div className="pageheader">
                    ...
                    <div>
                        <input type="button" className="text-lg font-semibold text-white bg-blue-800 p-[3px] px-[8px] rounded-[5px]" value="Add Expense" onClick={() => { toggleform(!showform) }} />
                    </div>
                </div>
            ...
            {showform && <Expenseform closeform={toggleform} />}
        </div>
    )
}